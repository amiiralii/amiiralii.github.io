...
sections:
  ...
  - block: markdown
    content:
      ...
      subtitle: ''
      text: |-
          Bigger isn’t always better. My research, guided by my advisor Dr. [Timm Menzies](https://timm.fyi/){:style="color: inherit; text-decoration: none; font-weight: inherit;"}, challenges the idea that ML in software engineering needs massive datasets to be effective. Instead, I explore how we can do more with less: tackling real SE problems with fewer, higher-quality labels.
